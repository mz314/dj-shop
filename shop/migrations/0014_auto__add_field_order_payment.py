...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Order.payment'
        db.add_column(u'shop_order', 'payment',
                      self.gf('django.db.models.fields.related.ForeignKey')(default=1, to=orm['shop.PaymentMethod']),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Order.payment'
        db.delete_column(u'shop_order', 'payment_id')
