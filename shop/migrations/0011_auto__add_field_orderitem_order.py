...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.add_column(u'shop_orderitem', 'order',
                      self.gf('django.db.models.fields.related.ForeignKey')(default=1, to=orm['shop.Order']),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'OrderItem.order'
        db.delete_column(u'shop_orderitem', 'order_id')
