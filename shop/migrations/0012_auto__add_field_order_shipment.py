...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Order.shipment'
        db.add_column(u'shop_order', 'shipment',
                      self.gf('django.db.models.fields.related.ForeignKey')(default=1, to=orm['shop.ShipmentMethod']),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Order.shipment'
        db.delete_column(u'shop_order', 'shipment_id')
