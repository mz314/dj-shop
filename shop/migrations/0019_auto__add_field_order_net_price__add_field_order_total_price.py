...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Order.net_price'
        db.add_column(u'shop_order', 'net_price',
                      self.gf('django.db.models.fields.DecimalField')(default=0, max_digits=10, decimal_places=2),
                      keep_default=False)

        # Adding field 'Order.total_price'
        db.add_column(u'shop_order', 'total_price',
                      self.gf('django.db.models.fields.DecimalField')(default=0, max_digits=10, decimal_places=2),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Order.net_price'
        db.delete_column(u'shop_order', 'net_price')

        # Deleting field 'Order.total_price'
        db.delete_column(u'shop_order', 'total_price')
    ...
    models = {
        ...
        u'shop.order': {
            ...
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'net_price': ('django.db.models.fields.DecimalField', [], {'max_digits': '10', 'decimal_places': '2'}),
