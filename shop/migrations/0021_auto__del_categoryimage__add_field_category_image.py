...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.delete_table(u'shop_categoryimage')

        # Adding field 'Category.image'
        db.add_column(u'shop_category', 'image',
    ...
    def backwards(self, orm):
        ...
        db.create_table(u'shop_categoryimage', (
        ...
        db.send_create_signal(u'shop', ['CategoryImage'])

        # Deleting field 'Category.image'
        db.delete_column(u'shop_category', 'image')
