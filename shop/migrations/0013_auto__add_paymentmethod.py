...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.create_table(u'shop_paymentmethod', (
            ...
            ('currency', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['shop.Currency'], null=True, blank=True)),
            ('name', self.gf('django.db.models.fields.CharField')(max_length=128)),
            ('gw_url', self.gf('django.db.models.fields.CharField')(max_length=256)),
        ))
        db.send_create_signal(u'shop', ['PaymentMethod'])


    def backwards(self, orm):
        # Deleting model 'PaymentMethod'
        db.delete_table(u'shop_paymentmethod')
    ...
    models = {
        ...
        u'shop.paymentmethod': {
            ...
            'currency': ('django.db.models.fields.related.ForeignKey', [], {'to': u"orm['shop.Currency']", 'null': 'True', 'blank': 'True'}),
            'gw_url': ('django.db.models.fields.CharField', [], {'max_length': '256'}),
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'name': ('django.db.models.fields.CharField', [], {'max_length': '128'}),
            'price': ('django.db.models.fields.DecimalField', [], {'default': '0.0', 'null': 'True', 'max_digits': '10', 'decimal_places': '2', 'blank': 'True'}),
            'tax': ('django.db.models.fields.related.ForeignKey', [], {'to': u"orm['shop.Tax']", 'null': 'True', 'blank': 'True'})
