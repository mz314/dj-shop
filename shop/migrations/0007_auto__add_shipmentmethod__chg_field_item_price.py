...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.create_table(u'shop_shipmentmethod', (
            (u'id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('price', self.gf('django.db.models.fields.DecimalField')(default=0.0, null=True, max_digits=10, decimal_places=2, blank=True)),
        ...
        db.send_create_signal(u'shop', ['ShipmentMethod'])


        # Changing field 'Item.price'
        db.alter_column(u'shop_item', 'price', self.gf('django.db.models.fields.DecimalField')(null=True, max_digits=10, decimal_places=2))

    def backwards(self, orm):
        # Deleting model 'ShipmentMethod'
        db.delete_table(u'shop_shipmentmethod')


        # Changing field 'Item.price'
        db.alter_column(u'shop_item', 'price', self.gf('django.db.models.fields.DecimalField')(default=0.0, max_digits=10, decimal_places=2))
