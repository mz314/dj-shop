...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'ShipmentMethod.enabled'
        db.add_column(u'shop_shipmentmethod', 'enabled',
                      self.gf('django.db.models.fields.BooleanField')(default=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'ShipmentMethod.enabled'
        db.delete_column(u'shop_shipmentmethod', 'enabled')
