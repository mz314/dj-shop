...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Deleting field 'PaymentMethod.gw_url'
        db.delete_column(u'shop_paymentmethod', 'gw_url')

        # Adding field 'PaymentMethod.config'
        db.add_column(u'shop_paymentmethod', 'config',
    ...
    def backwards(self, orm):
        ...
        # Adding field 'PaymentMethod.gw_url'
        db.add_column(u'shop_paymentmethod', 'gw_url',
                      self.gf('django.db.models.fields.CharField')(default='', max_length=256),
                      keep_default=False)

        # Deleting field 'PaymentMethod.config'
        db.delete_column(u'shop_paymentmethod', 'config')
