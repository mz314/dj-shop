...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Item.width'
        db.add_column(u'shop_item', 'width',
                      self.gf('django.db.models.fields.DecimalField')(default=None, null=True, max_digits=10, decimal_places=8, blank=True),
                      keep_default=False)

        # Adding field 'Item.height'
        db.add_column(u'shop_item', 'height',
                      self.gf('django.db.models.fields.DecimalField')(default=None, null=True, max_digits=10, decimal_places=8, blank=True),
                      keep_default=False)

        # Adding field 'Item.depth'
        db.add_column(u'shop_item', 'depth',
                      self.gf('django.db.models.fields.DecimalField')(default=None, null=True, max_digits=10, decimal_places=8, blank=True),
                      keep_default=False)
    ...
    def backwards(self, orm):
        ...
        db.delete_column(u'shop_item', 'width')

        # Deleting field 'Item.height'
        db.delete_column(u'shop_item', 'height')

        # Deleting field 'Item.depth'
        db.delete_column(u'shop_item', 'depth')
    ...
    models = {
        ...
        u'shop.item': {
            ...
            'depth': ('django.db.models.fields.DecimalField', [], {'default': 'None', 'null': 'True', 'max_digits': '10', 'decimal_places': '8', 'blank': 'True'}),
            'descripion': ('django.db.models.fields.TextField', [], {'null': 'True', 'blank': 'True'}),
            'height': ('django.db.models.fields.DecimalField', [], {'default': 'None', 'null': 'True', 'max_digits': '10', 'decimal_places': '8', 'blank': 'True'}),
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'name': ('django.db.models.fields.CharField', [], {'max_length': '128'}),
            ...
            'weight': ('django.db.models.fields.DecimalField', [], {'default': 'None', 'null': 'True', 'max_digits': '10', 'decimal_places': '8', 'blank': 'True'}),
            'width': ('django.db.models.fields.DecimalField', [], {'default': 'None', 'null': 'True', 'max_digits': '10', 'decimal_places': '8', 'blank': 'True'})
        },
        u'shop.itemimage': {
