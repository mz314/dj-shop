...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Deleting field 'ItemImage.main'
        db.delete_column(u'shop_itemimage', 'main')

        # Adding field 'ItemImage.main_image'
        db.add_column(u'shop_itemimage', 'main_image',
                      self.gf('django.db.models.fields.BooleanField')(default=False),
                      keep_default=False)


    def backwards(self, orm):
        # Adding field 'ItemImage.main'
        db.add_column(u'shop_itemimage', 'main',
                      self.gf('django.db.models.fields.BooleanField')(default=False),
                      keep_default=False)

        # Deleting field 'ItemImage.main_image'
        db.delete_column(u'shop_itemimage', 'main_image')
    ...
    models = {
        ...
        u'shop.item': {
            ...
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'images': ('django.db.models.fields.related.ManyToManyField', [], {'to': u"orm['shop.ItemImage']", 'symmetrical': 'False'}),
            'name': ('django.db.models.fields.CharField', [], {'max_length': '128'}),
