...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'Item.currency'
        db.alter_column(u'shop_item', 'currency_id', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['shop.Currency'], null=True))

        # Changing field 'ShipmentMethod.currency'
        db.alter_column(u'shop_shipmentmethod', 'currency_id', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['shop.Currency'], null=True))

    def backwards(self, orm):

        # Changing field 'Item.currency'
        db.alter_column(u'shop_item', 'currency_id', self.gf('django.db.models.fields.related.ForeignKey')(default=0, to=orm['shop.Currency']))

        # Changing field 'ShipmentMethod.currency'
        db.alter_column(u'shop_shipmentmethod', 'currency_id', self.gf('django.db.models.fields.related.ForeignKey')(default=0, to=orm['shop.Currency']))
