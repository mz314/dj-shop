...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'ItemImage.item'
        db.add_column(u'shop_itemimage', 'item',
                      self.gf('django.db.models.fields.related.ForeignKey')(default=1, to=orm['shop.Item']),
                      keep_default=False)
    ...
    def backwards(self, orm):
        # Deleting field 'ItemImage.item'
        db.delete_column(u'shop_itemimage', 'item_id')
